...
import WelcomeCard from "../../Components/LandPage/CardWelcome";
import TypeCard from "../../Components/LandPage/TypeCard";
...
const LandPage = () => {
  ...
  useEffect(() => {
    ...
    types.map((card) => {
      components.push(
        <TypeCard img={card.img} text={card.text} title={card.title} />
      );
    });
    ...
    <div className={classes.mainDiv}>
      ...
      <div className={classes.divHeader}>
        ...
        <div className={classes.divButtonsHeader}>
          <div className={`${classes.divPlayNow} ${classes.iconHover}`}>
      ...
      <div className={classes.mainDiv}>
        ...
        >
          ...
          <div className={classes.divVersusTitle}>
            <img src={versusTitle} alt="" width={1000} />
          </div>
        ...
        <Container className={classes.containerNews}>
          ...
          <div className={classes.divNews}>
            <div className={classes.news} style={{ marginRight: 30 }}>
            ...
            <div className={classes.news}>
              ...
              <div style={{ position: "relative", width: "90%", flexGrow: 1 }}>
                <div
                  style={{
                    position: "absolute",
                    zIndex: 2,
